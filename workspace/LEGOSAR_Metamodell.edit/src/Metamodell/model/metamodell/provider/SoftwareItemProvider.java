...
/**
 * This is the item provider adapter for a {@link Metamodell.model.metamodell.Software} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SoftwareItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodellPackage.Literals.SOFTWARE__SW_CONNECTIONS);
			childrenFeatures.add(MetamodellPackage.Literals.SOFTWARE__SW_SWCS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Software_type");
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodellPackage.Literals.SOFTWARE__SW_CONNECTIONS,
				 MetamodellFactory.eINSTANCE.createConnection()));

		newChildDescriptors.add
			(createChildParameter
				(MetamodellPackage.Literals.SOFTWARE__SW_SWCS,
				 MetamodellFactory.eINSTANCE.createSWC()));
	}
