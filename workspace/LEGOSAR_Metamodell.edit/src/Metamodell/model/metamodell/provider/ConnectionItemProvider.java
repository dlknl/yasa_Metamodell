...
/**
 * This is the item provider adapter for a {@link Metamodell.model.metamodell.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodellPackage.Literals.CONNECTION__CONN_SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodellPackage.Literals.CONNECTION__CONN_DESTINATIONS,
				 true,
				 false,
				 true,
				 null,
