 ...
 * <ul>
 *   <li>{@link LEGOSAR.model.legosar.impl.EventImpl#getEvent_name <em>Event name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends EObjectImpl implements Event {
	...
	protected EClass eStaticClass() {
		return LegosarPackage.Literals.EVENT;
	}
	...
	public void setEvent_name(String newEvent_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegosarPackage.EVENT__EVENT_NAME, oldEvent_name, event_name));
	}
