 ...
 * <ul>
 *   <li>{@link LEGOSAR.model.legosar.impl.PortImpl#getPort_name <em>Port name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PortImpl extends EObjectImpl implements Port {
	...
	protected EClass eStaticClass() {
		return LegosarPackage.Literals.PORT;
	}
	...
	public void setPort_name(String newPort_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegosarPackage.PORT__PORT_NAME, oldPort_name, port_name));
	}
