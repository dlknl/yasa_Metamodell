...
public class AlarmImpl extends EObjectImpl implements Alarm {
	 ...
	 * @ordered
	 */
	protected EList<Integer> alarm_cycletime;
	 ...
	 * @generated
	 */
	public EList<Integer> getAlarm_cycletime() {
		if (alarm_cycletime == null) {
			alarm_cycletime = new EDataTypeUniqueEList<Integer>(Integer.class, this, LegosarPackage.ALARM__ALARM_CYCLETIME);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case LegosarPackage.ALARM__ALARM_CYCLETIME:
				...
				getAlarm_cycletime().addAll((Collection<? extends Integer>)newValue);
				return;
		}
