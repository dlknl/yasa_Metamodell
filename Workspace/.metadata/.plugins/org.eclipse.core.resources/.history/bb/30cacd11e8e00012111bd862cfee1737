...
/**
 * This is the item provider adapter for a {@link LEGOSAR.model.legosar.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSensor_portPropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addSensor_portPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_sensor_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_sensor_port_feature", "_UI_Sensor_type"),
				 LegosarPackage.Literals.SENSOR__SENSOR_PORT,
				 true,
				 false,
				 false,
