...
/**
 * This is the item provider adapter for a {@link LEGOSAR.model.legosar.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEvent_namePropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addEvent_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_event_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_event_name_feature", "_UI_Event_type"),
				 LegosarPackage.Literals.EVENT__EVENT_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Event)object).getEvent_name();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Event.class)) {
			case LegosarPackage.EVENT__EVENT_NAME:
